...
<div class="container mx-auto" >
  <div class="col-md-5">
    <div class="form-area">
      <form action="feedback" method="post" name="registerform">
        <br style="clear:both">
        ...
        <div class="form-group">
          <textarea class="form-control" name="feedback" type="textarea" id="message" placeholder="Add your feedback!" maxlength="140" rows="7"></textarea>
          
        </div>

        <button type="sumbit" id="submit" name="submit" class="btn btn-primary pull-right btn-dark">Submit Form</button>
      </form>
    </div>
  </div>
</div>
